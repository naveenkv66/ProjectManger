...
namespace ProjectManagerService.Tests.UnitTest
{
    public class MockProjectManager
    {
        public ProjectManagerEntities MockDataSetList()
        {
            ...
            mockContext.Projects1.Returns(mocksetProjects);
            mockContext.Users1.Returns(mocksetUsers);
            mockContext.Tasks1.Returns(mocksetTasks);
            mockContext.ParentTasks1.Returns(mocksetPTasks);
